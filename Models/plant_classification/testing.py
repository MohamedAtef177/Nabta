...
model = models.load_model("plants_classification_inception_V3_2")
...
pickle_out = open("test_result_plants_2.pickle", "wb")
pickle.dump(yhat, pickle_out)
pickle_out.close()
'''
yhat = pickle.load(open("test_result_plants_2.pickle", "rb"))
