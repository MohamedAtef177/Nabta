...
X_test = pickle.load(open("X_test_Strawberry.pickle", "rb"))
Y_test = pickle.load(open("Y_test_Strawberry.pickle", "rb"))


model = models.load_model("Strawberry_diseases_inception__V3")
...
pickle_out = open("test_result_Strawberry_diseases.pickle", "wb")
pickle.dump(yhat, pickle_out)
pickle_out.close()
''' 
yhat = pickle.load(open("test_result_Strawberry_diseases.pickle", "rb"))
'''
y = []
for i in yhat:
...
plot_confusion_matrix(cm1,
                      ["healthy", "Leaf_scorch"],
                      title='Strawberry Confusion matrix',
                      cmap=None,
                      normalize=False)
