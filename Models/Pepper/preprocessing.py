...
types = ["Pepper,_bell___Bacterial_spot", "Pepper,_bell___healthy"]
...
pickle_out = open("X_train_Pepper.pickle", "wb")
pickle.dump(X_train, pickle_out)
pickle_out.close()

pickle_out = open("Y_train_Pepper.pickle", "wb")
pickle.dump(Y_train, pickle_out)
pickle_out.close()

pickle_out = open("X_test_Pepper.pickle", "wb")
pickle.dump(X_test, pickle_out)
pickle_out.close()

pickle_out = open("Y_test_Pepper.pickle", "wb")
