...
X_test = pickle.load(open("X_test_Pepper.pickle", "rb"))
Y_test = pickle.load(open("Y_test_Pepper.pickle", "rb"))

'''
model = models.load_model("Pepper_diseases_inception__V3")
...
pickle_out = open("test_result_Pepper_diseases.pickle", "wb")
pickle.dump(yhat, pickle_out)
pickle_out.close()
''' 
yhat = pickle.load(open("test_result_Pepper_diseases.pickle", "rb"))
