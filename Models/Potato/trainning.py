...
x = pickle.load(open("X_train_Potato.pickle", "rb"))
y = pickle.load(open("Y_train_Potato.pickle", "rb"))
print(len(x))
print(len(y))
...
output = Dense(3, activation='softmax')(class5)
...
model.save("Potato_diseases_inception__V3")
