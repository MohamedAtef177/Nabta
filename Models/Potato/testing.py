...
X_test = pickle.load(open("X_test_Potato.pickle", "rb"))
Y_test = pickle.load(open("Y_test_Potato.pickle", "rb"))


model = models.load_model("Potato_diseases_inception__V3")
...
pickle_out = open("test_result_Potato_diseases.pickle", "wb")
pickle.dump(yhat, pickle_out)
pickle_out.close()
''' 
yhat = pickle.load(open("test_result_Potato_diseases.pickle", "rb"))
'''
y = []
for i in yhat:
