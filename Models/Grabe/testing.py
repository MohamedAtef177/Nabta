...
X_test = pickle.load(open("X_test_grape.pickle", "rb"))
Y_test = pickle.load(open("Y_test_grape.pickle", "rb"))


model = models.load_model("grape_diseases_inception_V3_1")
...
pickle_out = open("test_result_grape_diseases.pickle", "wb")
...
plot_confusion_matrix(cm1,
                      ["Black_rot", "Black_Measles", "healthy", "Isariopsis_Leaf_Spot"],
                      title='Grape Confusion matrix',
                      cmap=None,
                      normalize=False)
