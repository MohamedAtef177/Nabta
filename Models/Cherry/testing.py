...
X_test = pickle.load(open("X_test_Cherry.pickle", "rb"))
Y_test = pickle.load(open("Y_test_Cherry.pickle", "rb"))


model = models.load_model("Cherry_diseases_inception__V3_2")
...
pickle_out = open("test_result_Cherry_diseases_2.pickle", "wb")
pickle.dump(yhat, pickle_out)
pickle_out.close()
'''
yhat = pickle.load(open("test_result_Cherry_diseases_2.pickle", "rb"))
'''
y = []
for i in yhat:
