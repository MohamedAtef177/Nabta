...
types = ["Cherry_(including_sour)___healthy", "Cherry_(including_sour)___Powdery_mildew"]
...
pickle_out = open("Y_train_Cherry.pickle", "wb")
pickle.dump(Y_train, pickle_out)
pickle_out.close()

print("3")

pickle_out = open("X_test_Cherry.pickle", "wb")
pickle.dump(X_test, pickle_out)
pickle_out.close()

print("4")

pickle_out = open("Y_test_Cherry.pickle", "wb")
pickle.dump(Y_test, pickle_out)
pickle_out.close()

print("5")

pickle_out = open("X_train_Cherry.pickle", "wb")
