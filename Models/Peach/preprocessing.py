...
types = ["Peach___Bacterial_spot", "Peach___healthy"]
...
pickle_out = open("X_train_Peach.pickle", "wb")
pickle.dump(X_train, pickle_out)
pickle_out.close()

pickle_out = open("Y_train_Peach.pickle", "wb")
pickle.dump(Y_train, pickle_out)
pickle_out.close()

pickle_out = open("X_test_Peach.pickle", "wb")
pickle.dump(X_test, pickle_out)
pickle_out.close()

pickle_out = open("Y_test_Peach.pickle", "wb")
