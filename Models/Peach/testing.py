...
X_test = pickle.load(open("X_test_Peach.pickle", "rb"))
Y_test = pickle.load(open("Y_test_Peach.pickle", "rb"))

'''
model = models.load_model("Peach_diseases_inception__V3")
...
pickle_out = open("test_result_Peach_diseases.pickle", "wb")
pickle.dump(yhat, pickle_out)
pickle_out.close()
''' 
yhat = pickle.load(open("test_result_Peach_diseases.pickle", "rb"))
